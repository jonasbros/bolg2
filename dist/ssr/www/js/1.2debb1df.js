...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/layouts/MainLayout.vue?vue&type=template&id=3b45b264&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('q-layout',{attrs:{"view":"lHh Lpr lFf"}},[_c('Nav',{attrs:{"isAuthUser":_vm.isAuthUser},on:{"openDrawer":function($event){_vm.drawer = true},"logout":_vm.logout}}),_c('DrawerNav',{attrs:{"isAuthUser":_vm.isAuthUser},on:{"drawer":function($event){_vm.drawer = false},"logout":_vm.logout},model:{value:(_vm.drawer),callback:function ($$v) {_vm.drawer=$$v},expression:"drawer"}}),_c('q-page-container',[_c('router-view')],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/layouts/MainLayout.vue?vue&type=template&id=3b45b264&
...
/* harmony default export */ var MainLayoutvue_type_script_lang_js_ = ({
  ...
  methods: {
    logout() {
      config["a" /* firebase */].auth().signOut().then(() => {
...
runtime_auto_import_default()(component, 'components', {QLayout: QLayout["a" /* default */],QPageContainer: QPageContainer["a" /* default */],QDrawer: QDrawer["a" /* default */]});
...
//# sourceMappingURL=1.2debb1df.js.map